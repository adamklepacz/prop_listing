      ...
      <form ref={input => this.form = input} className="filter">
          ...
          <div className="filterBox filterFrom">
              ...
              <select id="priceFrom" name="priceFrom" onChange={(e) => handleFilterChange(e)}>
                  ...
                  <option value="500000">{priceFormatter(500000)}</option>
                  <option value="600000">{priceFormatter(600000)}</option>
                  <option value="700000">{priceFormatter(700000)}</option>
                  <option value="800000">{priceFormatter(800000)}</option>
                  <option value="900000">{priceFormatter(900000)}</option>
              </select>
          </div>
          <div className="filterBox">
              ...
              <select id="priceTo" name="priceTo" onChange={(e) => handleFilterChange(e)}>
                  ...
                  <option value="800000">{priceFormatter(800000)}</option>
                  <option value="900000">{priceFormatter(900000)}</option>
                  <option value="1000000">{priceFormatter(1000000)}</option>
              </select>
          </div>
          <div className="filterBox">
